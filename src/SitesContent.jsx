...
const briefing = [
  ...
  { id:'cms', group:'Admin / CMS', title:'O cliente precisará editar conteúdos do site?', status:'Definir antes do desenvolvimento', text:'Um Admin ou CMS pode ser necessário quando o site tiver blog ou quando o cliente quiser atualizar conteúdos sem depender da equipe de desenvolvimento. Defina o que poderá ser gerenciado e por quem.', items:['Blog e publicação de posts','Textos e páginas institucionais','Serviços, projetos e equipe','Unidades, banners e documentos','Usuários, acessos e permissões'], note:'O site pode ser estático quando não houver necessidade de atualização pelo cliente. Admin, CMS, conteúdo dinâmico, autenticação e hospedagem possuem escopo, prazo e custos próprios.' },
